                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                             <b><i>Authenticate Your Society</i></b>
                          </header>
                          <div class="panel-body">
                              <div class="form">
                                  <form class="cmxform form-horizontal tasi-form" id="signupForm" method="post" action="<%=request.getContextPath()%>/Society_details">
                                      
                                      <div class="form-group ">
                                          <label for="board_contact" class="control-label col-lg-2">Contact Name of Management Committee OR Board Member</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="board_contact" name="board_contact" type="text" />
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                       ...
                                       <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="society_full_name" name="society_full_name" type="text" />
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              ...
                                              <option value="">--Select State--</option>
                                               		<d:forEach items="${sessionScope.state_list }" var="j" >
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class="form-control " id="pincode" name="pincode" type="number" requierd/>
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class="form-control " id="total_house" name="total_house" type="number" requierd />
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class="form-control" id="email" name="email" type="email" placeholder="xyz@gmail.com"/>
                                          </div>
                                      </div>
