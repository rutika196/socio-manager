				                              ...
				                              <div class=" form">
				                                  <form class="cmxform form-horizontal tasi-form" method="get" action="">
				                                    ...
				                                    <div class="form-group ">
				                                          <label for="type" class="control-label col-lg-2">Type of Notice</label>
				                                          <div class="col-lg-10">
				                                              <select id="state" class="form-control" name="type" required>
                                                  ...
                                                  <div class="col-lg-4 col-xs-6">
				                                      ...
				                                      <div class="form-group ">
				                                          <label for="sender" class="control-label col-lg-2">Reciever</label>
				                                          <div class="col-lg-10">
				                                              <select id="state" class="form-control" name="sender" required>
				                                      ...
				                                      <div class="form-group ">
				                                          ...
				                                          <div class="col-lg-10">
				                                              <textarea class="form-control " id="ccomment" name="detatil" required></textarea>
				                                          </div>
				                                      </div>
				                                      <div class="form-group">
