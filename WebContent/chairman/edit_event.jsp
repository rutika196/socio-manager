                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="cmxform form-horizontal tasi-form" id="signupForm" method="get" action="<%=request.getContextPath()%>/Event">
                                     <c:forEach items="${sessionScope.i }" var="i">
                                      <div class="form-group ">
                                          <label for="event_name" class="control-label col-lg-2">Title</label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="event_name" name="event_name" type="text" value="${i.title }" />
                                              <input type="hidden" value="update" name="flag">
                                              <input type="hidden" value="${i.event_Id}" name="id">
                                          </div>
                                      </div>
                                      ...
                                      <div class="col-lg-4">
                                          <div data-date="2012-12-21T15:25:00Z" class="input-group date form_datetime-meridian">
                                              <input type="text" class="form-control" readonly="" size="16"id="date" name="date" value="${i.date_Time }">
                                     	    ...
                                     	    <div class="form-group ">
                                          <label for="resident_fname" class="control-label col-lg-2">Hald At</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="resident_fname" name="place_name" type="text" value="${i.place }"/>
                                          </div>
                                      </div>
	                                 	...
	                                 	<div class="form-group ">
		                                          ...
		                                          <div class="col-lg-10">
		                                              <textarea class="form-control " id="Wing_address" name="details" requierd>${i.about }</textarea>
		                                          </div>
		                                </div>
