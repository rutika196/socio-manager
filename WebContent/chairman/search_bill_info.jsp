...
<html lang="en">
  <head>
    ...
    <![endif]-->
        <script src="${pageContext.request.contextPath}/chairman/js/jspdf.debug.js"></script>
		<script src="${pageContext.request.contextPath}/chairman/js/jquery-git.js"></script>
		<script>
