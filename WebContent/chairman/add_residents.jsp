                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                             <b><i>Add Residents</i></b>
                          </header>
                          <div class="panel-body">
                              <div class="form">
                                  <form class="cmxform form-horizontal tasi-form" id="signupForm" method="post" action="<%= request.getContextPath() %>/Resident">
                                      
                                      <div class="form-group ">
                                          <label for="resident_fname" class="control-label col-lg-2">Full Name</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="resident_fname" name="resident_fname" type="text" />
                                          </div>
                                      </div>
                                      ...
                                      <div class="col-lg-10">
                                          ...
                                          <div class="radio">
                                              <label>
                                                  <input type="radio" name="radio" id="optionsRadios1" value="Committee" >
                                                  Committee 
                                              </label>
                                          </div>
                                          <div class="radio">
                                              <label>
                                                  <input type="radio" name="radio" id="optionsRadios2" value="Resident">
                                                  Resident
                                              </label>
                                          </div>
										  ...
										  <div class="radio">
                                              <label>
                                                  <input type="radio" name="radio" id="optionsRadios3" value="Servant">
                                                  Servant
                                              </label>
                                          </div>
                                      </div>
	                                    ...
	                                    <div class="form-group">
	                                      ...
	                                      <div class="col-lg-10">
	                                          ...
	                                          <div class="col-lg-10">
	                                              <input class="form-control " id="house_no" name="house_no" type="number" required />
	                                          </div>
	                                       </div>
                                          ...
                                          <div class="col-lg-10">
                                              <input class="form-control " id="alternative_no" name="alternative_no" type="number" required/>
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <textarea class="form-control " id="bussiness_address" name="bussiness_address" ></textarea>
                                          </div>
                                      </div>                                     
                                     ...
                                     <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <textarea class="form-control " id="e_no" name="e_no"></textarea>
                                          </div>
                                      </div>  
