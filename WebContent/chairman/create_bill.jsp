                              ...
                              <div class="form">
                                  <form class="cmxform form-horizontal tasi-form" id="signupForm" method="get" action="">
                                      ...
                                      <div class="form-group ">
                                          <label for="bill_no" class="control-label col-lg-2">Bill No.</label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="bill_no" name="bill_no" type="number" required />
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                  		...
                                  		<div class="col-md-4">
                                          	...
                                          	<input type="text" class="form-control dpd1" name="dfrom"required>
                                          	<span class="input-group-addon">To</span>
                                          	<input type="text" class="form-control dpd2" name="dto"required>
                                      	</div>
                                      	<span class="help-block">Select date range</span>
                                     	    ...
                                     	    <div class="form-group ">
                                          <label for="resident_fname" class="control-label col-lg-2">Residant Name</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="resident_fname" name="resident_fname" type="text" required/>
                                          </div>
                                      </div>
                                      
                                      
                                      <div class="form-group ">
                                          <label for="charge_type" class="control-label col-lg-2">Charge Type</label>
                                          <div class="col-lg-10">
                                              <select id="charge_type" class="form-control" name="charge_type" required>
                                              <option value="">--charge type--</option>
                                               <option value="">Water Bill</option>
                                               <option value="">Maintaince</option>
                                       ...
                                       <div class="form-group ">
                                          <label for="flat_no" class="control-label col-lg-2">Flat No/House No.</label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="flat_no" name="flat_no" type="number" required />
                                          </div>
                                      </div>
                                       ...
                                       <div class="form-group ">
                                         ...
                                         <script src="https://www.paypalobjects.com/js/external/paypal-button.min.js?merchant=rp1961994@gmail.com" 
											    data-button="buynow" 
											    data-name="Your Total ammount is" 
											     data-amount="500" 
											    data-callback="#" 
											    data-env="sandbox"
											></script>                 
