...
<html lang="en">
  <head>
    ...
    <link href="${pageContext.request.contextPath}/chairman/css/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen"/>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/chairman/css/owl.carousel.css" type="text/css">
  ...
  <section id="container" >
                                          ...
                                          <div class="timeline-desk">
                                              <div class="panel">
                                                  <div class="panel-body">
                                                      ...
                                                      <div class="album">
                                                          <a href="#">
                                                              <img alt="" src="${pageContext.request.contextPath}/chairman/img/sm-img-1.jpg">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="${pageContext.request.contextPath}/chairman/img/sm-img-2.jpg">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="${pageContext.request.contextPath}/chairman/img/sm-img-3.jpg">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="${pageContext.request.contextPath}/chairman/img/sm-img-1.jpg">
                                                          </a>
    ...
    <script src="${pageContext.request.contextPath}/chairman/js/jquery.sparkline.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/chairman/js/jquery.easy-pie-chart.js"></script>
    <script src="${pageContext.request.contextPath}/chairman/js/owl.carousel.js" ></script>
    <script src="${pageContext.request.contextPath}/chairman/js/jquery.customSelect.min.js" ></script>
    <script src="${pageContext.request.contextPath}/chairman/js/respond.min.js" ></script>
    ...
    <script src="${pageContext.request.contextPath}/chairman/js/sparkline-chart.js"></script>
    <script src="${pageContext.request.contextPath}/chairman/js/easy-pie-chart.js"></script>
    <script src="${pageContext.request.contextPath}/chairman/js/count.js"></script>
