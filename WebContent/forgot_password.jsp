...
<head>
<meta charset="utf-8"/>
<title>Socio Manager | forgot pass</title>
...
<link id="style_color" href="${pageContext.request.contextPath}/css/themes/default.css" rel="stylesheet" type="text/css"/>
...
<div class="logo">
	<a href="index.jsp">
	<img src="${pageContext.request.contextPath}/Admin/img/logo-big.png" alt=""/>
	</a>
</div>
END LOGO
	...
	Layout.init(); // init current layout
 	Login.init();
  	Demo.init();
       ...
       $.backstretch([
        "${pageContext.request.contextPath}/img/k.jpg"
