                              ...
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" id="commentForm" method="get" action="">
                                     ...
                                     <div class="form-group ">
                                      ...
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">Add Notification</label>
                                          <div class="col-lg-10">
									     ...
									     <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Notify To</label>
                                          <div class="col-lg-10">
                                              <select id="minbeds" class="form-control" name="minbeds">
													<option>1</option>
													<option>2</option>
													<option>3</option>
													<option>4</option>
									   ...
									   <div class="form-group ">
                                          <label for="agree" class="control-label col-lg-2 col-sm-3">By</label>
                                         	<div class="checkbox">
												<label>
													<input type="checkbox">
														SMS
