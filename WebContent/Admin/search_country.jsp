              ...
              <section class="panel">
                      ...
                      <div class="adv-table editable-table ">
                          ...
                          <c:remove var="error" scope="session"/>
                              ...
                              <tr class="">
                                  ...
                                  <td>${i.country_Des }</td>
                                  <td><a href="<%= request.getContextPath()%>/Country?id=${i.country_Id}&flag=edit">Edit</a></td>
                                  <td><a href="<%= request.getContextPath()%>/Country?id=${i.country_Id}&flag=delete">Delete</a></td>
				...
				<div class="row">
                      ...
                      <section class="panel">
                          <div class="panel-body">
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" method="get" action="<%= request.getContextPath()%>/Country">
                                  
                                  <c:forEach items="${ sessionScope.country}" var="i" >
									
													<input type="hidden" name="country_Id" value="${i.country_Id }"/>
													<input type="hidden" name="flag" value="update"/>
									
                                     <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Country Name</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="cname" name="country" minlength="2" type="text" value="${i.country_Name }"required />
                                          </div>
                                      </div>
                                     ...
                                     <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <textarea class="form-control " id="ccomment" name="comment" required>${i.country_Des }</textarea>
                                          </div>
                                      </div>
