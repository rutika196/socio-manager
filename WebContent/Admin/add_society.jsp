                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                              <lable>Add Society</lable>
                          </header>
                          <div class="panel-body">
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" method="post" action="<%= request.getContextPath()%>/Society_details">
                                  
                                     <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Society Name</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="cname" name="sname" minlength="2" type="text" required />
                                          </div>
                                      </div>
