                      ...
                      <div class="adv-table editable-table ">
                          ...
                          <div class="space15"></div>
							...
							<div class="row">
								...
								<label>
								<select class="form-control xsmall" name="editable-sample_length" size="1" aria-controls="editable-sample">
								...
								<div class="col-lg-6">
									...
									<label>
									Search:
									<input class="form-control medium" type="text" aria-controls="editable-sample">
									</label>
									</div>
									</div>
									</div>
                          <table class="table table-striped table-hover table-bordered" id="editable-sample">
                              ...
                              <tr class="">
                                  ...
                                  <td></td>
                                  <td class="center"></td>
                                  <td><a class="edit" href="javascript:;">Send</a></td>
                          ...
                          <div class="row">
							<div class="col-lg-6">
							<div id="editable-sample_info" class="dataTables_info">Showing 1 to 5 of 12 entries</div>
							</div>
							<div class="col-lg-6">
