                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" method="post" action="<%=request.getContextPath() %>/City">
                                  ...
                                  <div class="form-group ">
                                     ...
                                     <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="cname" name="city" minlength="2" type="text" required />
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="cname" name="area" minlength="2" type="text" required />
                                          </div>
                                      </div>
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="cname" name="pn" minlength="2" type="number" required />
                                          </div>
                                      </div>
