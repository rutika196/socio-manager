...
<meta charset="utf-8">
    ...
    <!--external ${pageContext.request.contextPath}/Admin/css-->
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                              <b><i><lable>Add Chairman</lable></i></b>
                          </header>
                          <div class="panel-body">
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" method="post" action="<%= request.getContextPath() %>/Chairman">
                                  
                                    <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Society Name</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="cname" name="soc_name" minlength="10" type="text" required />
                                          </div>
                                      </div>
                                      
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Chairman Full Name</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="cname" name="name" minlength="10" type="text" required />
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                       ...
                                       <div class="form-group ">
                                          <label for="s" class="control-label col-lg-2">Contact No.</label>
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="cno" name="cno" type="number" required />
                                          </div>
                                      </div>                                                               
                                       ...
                                       <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" id="cname" name="email_add" minlength="10" type="email" required />
                                          </div>
                                      </div>
