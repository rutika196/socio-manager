                      ...
                      <div class="adv-table editable-table ">
                          ...
                          <c:remove var="error" scope="session"/>
                              ...
                              <tr class="">
                                  ...
                                  <td>${i.state_Name }</td>
                                  <td>${i.state_Des }</td>
                                  <td><a href="<%= request.getContextPath()%>/State?id=${i.state_Id}&flag=edit">Edit</a></td>
                                  <td><a href="<%= request.getContextPath()%>/State?id=${i.state_Id}&flag=delete">Delete</a></td>
										...
										<div class="portlet-header" style="height:50px">
						                  ...
						                  <div class="col-lg-12">
						                      <section class="panel">
						                          ...
						                          <div class="panel-body">
						                              <div class=" form">
						                                  <form class="cmxform form-horizontal tasi-form" method="get" action="<%= request.getContextPath() %>/State">
						                                  
						                                  <c:forEach items="${sessionScope.state }" var="s">
												
																<input type="hidden" name="state_Id" value="${s.state_Id }"/>
						                                     ...
						                                     <div class="form-group ">
						                                          ...
						                                          <div class="col-lg-10">
						                                              <select id="minbeds" class="form-control" name="country" required>
										                                              <c:forEach items="${sessionScope.country_data }" var="i">
																					 		<c:if test="${i.country_Id eq s.country_Id.country_Id }">
																								<option value="${i.country_Id }" selected="selected">${i.country_Name}</option>
																							</c:if>
																							<c:if test="${i.country_Id ne s.country_Id.country_Id }">
						                                       ...
						                                       <div class="form-group ">
						                                          ...
						                                          <div class="col-lg-10">
						                                              <input class=" form-control" id="cname" name="state" minlength="2" type="text" value="${s.state_Name }" required />
						                                          </div>
                                      						  </div>
						                                       ...
						                                       <div class="form-group ">
						                                          ...
						                                          <div class="col-lg-10">
						                                              <textarea class="form-control" id="ccomment" name="comment" required>${s.state_Des }</textarea>
						                                          </div>
                                      						 </div>                                                             
