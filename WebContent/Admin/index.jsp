...
<title>SOCIO MANAGER</title>
    ...
    <link href="${pageContext.request.contextPath}/Admin/css/bootstrap-reset.${pageContext.request.contextPath}/Admin/css/Admin/css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/Admin/css/font-awesome.css" rel="stylesheet" />
    <link href="${pageContext.request.contextPath}/Admin/css/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen"/>
...
<!--main content start-->
    ...
    <script src="${pageContext.request.contextPath}/Admin/js/jquery.easy-pie-chart.js"></script>
    ...
    <script src="${pageContext.request.contextPath}/Admin/js/count.js"></script>
