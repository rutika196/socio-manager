                              ...
                              <tbody>
                              	<c:forEach items="${sessionScope.search_Data }" var="i">
                             		 ...
                             		 <tr class="">
                                 		...
                                 		<td>${i.chairman_Id }</td>
                                  		<td>${i.soc_Name }</td>
                                  		<td>${i.chairman_Name }</td>
                                  		<td>${i.chairman_Add }</td>
                                  		<td>${i.chairman_contact }</td>
                                  		<td>${i.chairman_Email }</td>
										...
										<div class="portlet-header" style="height:50px">
						                  ...
						                  <div class="col-lg-12">
						                      <section class="panel">
						                          ...
						                          <div class="panel-body">
						                              <div class=" form">
						                                  <form class="cmxform form-horizontal tasi-form" method="get" action="<%= request.getContextPath() %>/Chairman">
						                                  
						                                  <c:forEach items="${sessionScope.ch }" var="i">
												
																<input type="hidden" name="id" value="${i.chairman_Id }"/>
																<input type="hidden" name="flag" value="update"/>
												
						                                     <div class="form-group ">
                                          						<label for="cname" class="control-label col-lg-2">Society Name</label>
                                          					<div class="col-lg-10">
                                              					<input class=" form-control" id="cname" name="soc_name" minlength="10" type="text" value="${i.soc_Name }"required />
                                          					</div>
                                      						</div>
						                                      
						                                      <div class="form-group ">
						                                          <label for="cname" class="control-label col-lg-2">Chairman Name</label>
						                                          <div class="col-lg-10">
						                                              <input class=" form-control" id="cname" name="name" minlength="10" type="text" value="${i.chairman_Name }" required />
						                                          </div>
						                                      </div>
						                                       ...
						                                       <div class="form-group ">
						                                          ...
						                                          <div class="col-lg-10">
						                                              <textarea class="form-control " id="address" name="address" required>${i.chairman_Add }</textarea>
						                                          </div>
						                                      </div>
						                                      
						                                       <div class="form-group ">
						                                          <label for="cname" class="control-label col-lg-2">Contact No.</label>
						                                          <div class="col-lg-10">
						                                              <input class=" form-control" id="cno" name="cno" type="number" value="${i.chairman_contact }" required />
						                                          </div>
						                                      </div>   
						                                      ...
						                                      <div class="form-group ">
						                                          ...
						                                          <div class="col-lg-10">
						                                              <input class=" form-control" id="cname" name="email_add" minlength="10" type="email" value="${i.chairman_Email }" required />
						                                          </div>
						                                      </div>                                                            
